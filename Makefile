...
$(PROFILE_FOLDER): multilocale applications-data preferences app-makefiles test-agent-config offline contacts extensions install-xulrunner-sdk $(PROFILE_FOLDER)/settings.json create-default-data
