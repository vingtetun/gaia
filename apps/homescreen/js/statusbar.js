    ...
    onAppReady: function() {
      appManager.app.connect('change-appearance-statusbar').then(
        function ok(ports) {
          ...
          this.scrollable.addEventListener('scroll', this);
          window.addEventListener('homescreen-editmode-start', this);
          window.addEventListener('homescreen-editmode-end', this);
